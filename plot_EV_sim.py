...
def plot_obj(fixed=True, dump_dir="results/dump/", fig_dir="results/"):
    ...
    if fixed:
        L_name = 'EV2[L]__fixed_int_max_n=1000_step_n=50_start_n=100_reps=40_capacity=1000000'
...
if __name__ == "__main__":
    #plot_obj(fixed=True, dump_dir="results/dump/", fig_dir="results/")
    plot_ar(fixed=True, dump_dir="results/dump/", y_label='Approximation Ratio', fig_dir="results/")
